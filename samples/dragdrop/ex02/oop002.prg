...
*/
PROCEDURE oop002( oParent )
   LOCAL oDlg, oMlayout
   LOCAL oHlay

   WITH OBJECT oDlg := hqlChildDialog( /*name*/, oParent )
      :setWindowTitle("HQL drag&drop tablewidget, bidirectional")
      :resize( 640, 480 )
      ...
      WITH OBJECT hqlTableWidget( "tab01" )
         ...
         :setDragDropMode( QAbstractItemView_DragDrop )
...
STATIC PROCEDURE udfAddRow( oTableWidget )
   ...
   FOR nCounter := 1 TO 30
      ...
      cNumber := hql_Transform( (nCounter * 10000), /*nomask*/ )
