...
STATIC PROCEDURE UDFshowMainWindow()
   ...
   oSplash := hqlSplashScreen( /*cName*/, /*oParent*/ )
   oSplash:setPixmap( QPixmap( ":/mysplash" ) ) // embedded
   oWnd:hqlSetSplashScreen( oSplash )
   ...
   oSplash:show()
   oSplash:hqlShowMessage( "I'm thinking", Qt_AlignCenter, QColor() )
   hb_IdleSleep( 2 )
