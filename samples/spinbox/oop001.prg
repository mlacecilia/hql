...
STATIC PROCEDURE UDFshowMainWindow()
   ...
   WITH OBJECT oWnd := hqlMainWindow(/*name*/)
      :setWindowTitle( "HQLSPINBOX tester" )
         ...
         WITH OBJECT :hqlAddMenu(/*name*/)
            ...
            WITH OBJECT :hqlAddMenu( /*name*/ )
               ...
               WITH OBJECT :hqlAddAction( /*name*/ )
                  ...
                  :hqlOnTriggered( { || hql_MsgStop( "is="+hb_NtoC(oWnd:spin1:hqlValue()) ) } )
               END WITH
               WITH OBJECT :hqlAddAction( /*name*/ )
                  :hqlCaption( "&Set 50" )
                  :hqlOnTriggered( { || oWnd:spin1:hqlValue(50) } )
               END WITH
            END WITH
         END WITH
